...
//`include "or1200_defines.v"
  ...
  module keccak_ctrl(in512,hash_num,keccak_en,store_en,out_ready,byte_num,in_ready,hash_out32,cust5);
   ...
   assign in_ready = keccak_en && (!out_ready) && cust5;
   assign devide_en = out_ready && store_en;
  //assign hash_out32 = devided32;

//assign keccak_clk = (keccak_en==1&&cust5==0) ? 1'bX : clk;
